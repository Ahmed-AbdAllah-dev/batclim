...
export const metadata: Metadata = {
  ...
  description:
    "BATCLIM: Leader en systèmes de refroidissement industriel en Algérie. Chambres froides, refroidisseurs multitubulaires avec garantie 1 an. Installation et maintenance à Alger, Oran, Constantine, Annaba.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Solutions professionnelles de refroidissement industriel avec garantie 1 an. Chambres froides, refroidisseurs multitubulaires. Service à travers toute l'Algérie.",
    ...
    <html lang="en">
      <head>
        <meta
          ...
          content="69iDqYq1XnG_csTYxA_BsV6EY7RmdkTvLlgrjuf_eeI"
        />
      </head>
      <body>{children}</body>
    </html>
